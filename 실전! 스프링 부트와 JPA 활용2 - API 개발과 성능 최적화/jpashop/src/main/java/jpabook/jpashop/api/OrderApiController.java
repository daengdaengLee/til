...
public class OrderApiController {
    ...
    public List<Order> ordersV1() {
        var all = orderRepository.findAll(new OrderSearch());
        for (var order : all) {
    ...
    public List<OrderDto> ordersV3() {
        var orders = orderRepository.findAllWithItem();
        return orders.stream()
                .map(OrderDto::new)
                .toList();
    }
    ...
    public List<OrderDto> ordersV3_page(@RequestParam(value = "offset", defaultValue = "0") int offset,
        ...
        var orders = orderRepository.findAllWithMemberDelivery(offset, limit);
        return orders.stream()
                .map(OrderDto::new)
                .toList();
    }
    ...
    public List<OrderQueryDto> ordersV6() {
        var flats = orderQueryRepository.findAllByDto_flat();
        return flats.stream()
